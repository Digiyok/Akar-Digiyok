...
class PemetaanPeranController extends Controller
{
  ...
  public function index()
  {
    ...
    $mapping = Jabatan::select('id', 'name', 'category_id')->has('pscRoleMapping')->aktif()->orderBy('category_id')->orderBy('code')->get();
    ...
    $penempatan = Jabatan::select('id', 'name')->aktif()->orderBy('category_id')->get();
