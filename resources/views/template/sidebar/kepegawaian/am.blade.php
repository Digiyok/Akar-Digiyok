...
@section('sidebar-menu')
  ...
  <li class="nav-item {{ request()->routeIs('calon*') || request()->routeIs('spk*') ? 'active' : '' }}">
    <a class="nav-link {{ request()->routeIs('calon*') || request()->routeIs('spk*') ? '' : 'collapsed' }}"
      data-toggle="collapse" data-target="#collapseRekrutmen" href="#"
      aria-expanded="{{ request()->routeIs('calon*') || request()->routeIs('spk*') ? 'true' : 'false' }}"
      aria-controls="collapseRekrutmen">
      <i class="mdi mdi-account-multiple-plus"></i>
      <span>Rekrutmen</span>
    </a>
    <div class="collapse {{ request()->routeIs('calon*') || request()->routeIs('spk*') ? 'show' : '' }}"
